# COPYRIGHT: Zachary Wright Heller
# Project: flake8-quotes

# We vendor this to avoid depending on flake8-quotes,
# as this would defeat the purpose of this lighter fork
# of wemake-python-styleguide, which is to provide
# WPS violations without any additional flake8 plugin.
...
def get_docstring_tokens(tokens) -> Set[tokenize.TokenInfo]:
